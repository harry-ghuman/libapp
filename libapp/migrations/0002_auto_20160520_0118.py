# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-05-20 01:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(choices=[(1, 'G'), (2, 'PG'), (3, 'PG-13'), (4, '14A'), (5, 'R'), (6, 'NR')])),
            ],
            bases=('libapp.libitem',),
        ),
        ...
        migrations.AlterField(
            model_name='libitem',
            name='date_acquired',
            field=models.DateField(default=datetime.date(2016, 5, 20)),
        ),
    ]
